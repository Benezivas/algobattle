...
class Verifiertests(unittest.TestCase):
    ...
    def test_verify_semantics_of_solution(self):
        self.assertFalse(self.verifier.verify_semantics_of_solution([('h', '1', '1', '3')], [], 10, solution_type=False))
        self.assertTrue(self.verifier.verify_semantics_of_solution([('h', '1', '1', '3')], [('s', '5', '2')], 10, solution_type=False))
