...
class Matchtests(unittest.TestCase):
    ...
    def test_build(self):
        ...
        match_build_timeout = Match(self.problem, config_short_build_timeout, [team], cache_docker_containers=False)
        ...
        match_build_fail = Match(self.problem, config_short_build_timeout, [team], cache_docker_containers=False)
    ...
    def test_one_fight(self):
        ...
        match_run_timeout = Match(self.problem, config_short_timeout, [team], cache_docker_containers=False)
        ...
        match_solver_timeout = Match(self.problem, config_short_timeout, [team], cache_docker_containers=False)
