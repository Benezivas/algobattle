...
s 1 2 9
s 5 6 7
""".encode()), [('e', '1', '2'), ('e', '3', '2'), ('s', '1', '2', '9'), ('s', '5', '6', '7')])
...
class Verifiertests(unittest.TestCase):
    ...
    def test_verify_semantics_of_solution(self):
        ...
        self.assertFalse(self.verifier.verify_semantics_of_solution([('e', '1', '2'), ('e', '3', '1'), ('e', '3', '2')], [('s', '1', '2', '1')], 10, solution_type=False))
        self.assertTrue(self.verifier.verify_semantics_of_solution([('e', '1', '2'), ('e', '3', '1'), ('e', '3', '2')], [('s', '1', '2', '3')], 10, solution_type=False))
