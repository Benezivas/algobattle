...
class BattleWrapperTests(unittest.TestCase):
    ...
    def test_calculate_points_iterated_zero_rounds(self):
        self.assertEqual(Iterated.calculate_points({}, 100), {})
    ...
    def test_calculate_points_iterated_no_successful_round(self):
        ...
        self.assertEqual(Iterated.calculate_points(results, 100), {self.teams[0]: 50, self.teams[1]: 50})
    ...
    def test_calculate_points_iterated_domination(self):
        ...
        self.assertEqual(Iterated.calculate_points(results, 100), {self.teams[0]: 0, self.teams[1]: 100})

    def test_calculate_points_averaged_zero_rounds(self):
        self.assertEqual(Averaged.calculate_points({}, 100), {})
    ...
    def test_calculate_points_averaged_draw(self):
        ...
        self.assertEqual(Averaged.calculate_points(results, 100), {self.teams[0]: 50, self.teams[1]: 50})
    ...
    def test_calculate_points_averaged_domination(self):
        ...
        self.assertEqual(Averaged.calculate_points(results, 100), {self.teams[0]: 60, self.teams[1]: 40})
